...
<head>
<meta charset="utf-8">
<title>Powerful Pre-approved Letters</title>
...
<?php $SelectLeftCont=mysql_fetch_assoc(mysql_query("select * from power_left_content where status='1'")); 
$SelectRighttCont=mysql_fetch_assoc(mysql_query("select * from power_right_content where status='1'")); 
?>
...
<p><img src="userfiles/<?php echo $SelectRighttCont['image']; ?>" alt="<?php echo stripslashes($SelectRighttCont['img_alt']); ?>" title="<?php echo stripslashes($SelectRighttCont['img_title']); ?>" class="repreaaproval" /></p>
</div>          
</div> 
</div>
