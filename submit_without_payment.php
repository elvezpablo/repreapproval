 ...
 if($inser)// send Plan Upgrade Message message
   {
		...
		$insert=mysql_query("insert into companyinvoices(profile_id,lender_id,date_billing,amount,discount,exp_date,status)values('".$pro."','".$LanderId."','".$tty."','".$initialpayment."','".$_SESSION['Discount']."','".$date."','f')");
	   $subject= "Payment information";
		...
		<tr><td colspan="2" style="color:#000;">Hello '.$_SESSION['logge']['email'].',<br /><br/>This is the receipt for your membership plan upgrade at <strong>RePreApproval</strong>.<br/><br/>
		...
		<tr><td><strong style="color:#000;">Amount</strong></td><td><strong style="color:#045D92;">$0</strong></td></tr>
...
$subject= "Payment information";
		...
		<tr><td colspan="2" style="color:#000;">Hello '.$_SESSION['first_name'].',<br /><br/>This is the receipt for your membership purchase at <strong>RePreApproval</strong>.<br/><br/>
		Following is the details of your payment for your record.</td></tr>
