...
if(isset($_REQUEST['landsubmit']) and $_REQUEST['landsubmit']!='')
 {
	...
	$created=time();
	if($_REQUEST['idofrecord']!='' and $home_buyer!='' and $Cert_Gene_Date!='' and $Purchase_Price!='' and $Down_Payment!='' and $Loan_Type!='' and $Max_Qual_Interest!='' and  $Prop_Street_Addr!='' and $Prop_City!='' and $Prop_State!='' and $ZIP_Code!='')
	 {
	  $uted= mysql_query("update `letters` set `buyer_view`= 'SHOW', `buyer_id`= '".$home_buyer."', `pre_qual_no`= '".$Pre_qual."', `lead_id`= '".$Lead_id."', `generation_date`= '".$Cert_Gene_Date."', `expiry_date`= '".$Cert_Exxp_Date."', `purchase_price`= '".$Purchase_Price."', `down_payment`= '".$Down_Payment."', `loan_type`= '".$Loan_Type."', `loan_term`= '".$Loan_Term."', `payment_type`= '".$Payment_Typ."', `mortgage_one`= '".$firstst_Mortgage."', `mortgage_two`= '".$secst_Mortgage."', `property_type`= '".$Property_Type."', `Occupancy`= '".$Occupancy."', `loan_index`= '".$Loan_Index."', `loan_margin`= '".$Loan_Margin."', `max_qual_interest_rate`= '".$Max_Qual_Interest."', `credit_score`= '".$Credit_Score."', `mortgage_insurance`= '".$Mort_Insur."', `property_street`= '".$Prop_Street_Addr."', `property_suite`= '".$Prop_Suite_Apt."', `property_city`= '".$Prop_City."', `property_state`= '".$Prop_State."', `property_zip`= '".$ZIP_Code."', `created`= '".$stam."' where id= '".$_REQUEST['idofrecord']."'");
	  if($uted)
	   {
		 $_SESSION['msg']='pted';
		 header('location:lenderdashboard.php');
...
<div class="space20"></div><div class="container">
   ...
   ?><div class="login">
        <form name="registerform" id="registerform" action="" method="post" class="form-horizontal">
			   ...
			   if($oksw['otherbuyer']!='')
				{
				 ...
				 ?><option value="<?php echo $oksw['id']; ?>" <?php if($bhxwe['buyer_id']==$oksw['id']){ ?> selected <?php } ?> ><?php echo $oksw['firstname'].$ccdzx; ?></option><?php
			   }
			  ?></select>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-9">
              <input type="text"  name="Pre_qual" class="input poin" value="<?php echo $bhxwe['pre_qual_no']; ?>" size="50" />
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-3" for="">Lead ID</label>
            <div class="col-sm-9">
              <input type="text"  name="Lead_id" class="input" size="50" value="<?php echo $bhxwe['lead_id']; ?>"/>
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-3" for="">Certificate Generation Date*</label>
            <div class="col-sm-9">
              <input type="text"  name="Cert_Gene_Date" id="Cert_Gene_Date" class="input" size="50" value="<?php echo date('m/d/Y', $bhxwe['generation_date']); ?>" onBlur="fillfield('Cert_Gene_Date');"/>
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-3" for="">Certificate Expiration Date</label>
            <div class="col-sm-9">
              <input type="text"  name="Cert_Exp_Date" id="Cert_Exp_Date" class="input" size="50" value="<?php echo date('m/d/Y', $bhxwe['expiry_date']); ?>" readonly/>
            </div>
          </div>
          
          
          <div class="form-group"><label class="col-sm-3" for="">Purchase Price ($)*</label><div class="col-sm-9">
          <input type="text" name="Purchase_Price" id="Purchase_Price" class="input poin" size="50" value="<?php echo $bhxwe['purchase_price']; ?>" onBlur="fillfield('Purchase_Price');"/></div></div>
          
          
          <div class="form-group">
            <label class="col-sm-3" for="">Down Payment (%)*</label>
            <div class="col-sm-9">
              <input type="text"  name="Down_Payment" id="Down_Payment" class="input" size="50" value="<?php echo $bhxwe['down_payment']; ?>" onBlur="fillfield('Down_Payment');"/>
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-3" for="">Loan Type*</label>
            <div class="col-sm-9">
              <input type="text"  name="Loan_Type" id="Loan_Type" class="input" onBlur="fillfield('Loan_Type');" size="50" value="<?php echo $bhxwe['loan_type']; ?>"/>
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-3" for="">Loan Term*</label>
            <div class="col-sm-9">
              <input type="text"  name="Loan_Term" id="Loan_Term" class="input" onBlur="fillfield('Loan_Term');" size="50" value="<?php echo $bhxwe['loan_term']; ?>"/>
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-3" for="">Payment Type</label>
            <div class="col-sm-9">
              <input type="text"  name="Payment_Typ" id="Payment_Typ" class="input" size="50" value="<?php echo $bhxwe['payment_type']; ?>"/>
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-3" for="">1st Mortgage</label>
            <div class="col-sm-9">
              <input type="radio" name="firstst_Mortgage" id="firstst_Mortgage" value="Yes" <?php if($bhxwe['mortgage_one']=='Yes'){ ?> checked <?php } ?>/>
              &nbsp;&nbsp;Yes&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              <input type="radio" name="firstst_Mortgage" id="1st_Mortgagee" value="No" <?php if($bhxwe['mortgage_one']=='No'){ ?> checked <?php } ?>/>
              &nbsp;&nbsp;No</div>
          </div>
          <div class="form-group">
            <label class="col-sm-3" for="">2st Mortgage</label>
            <div class="col-sm-9">
              <input type="radio" name="secst_Mortgage" id="secst_Mortgage" value="Yes" <?php if($bhxwe['mortgage_two']=='Yes'){ ?> checked <?php } ?>/>
              &nbsp;&nbsp;Yes&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              <input type="radio" name="secst_Mortgage" id="2st_Mortgage" value="No" <?php if($bhxwe['mortgage_two']=='No'){ ?> checked <?php } ?>/>
              &nbsp;&nbsp;No</div>
          </div>
          <div class="form-group">
            <label class="col-sm-3" for="">Property Type</label>
            <div class="col-sm-9">
              <input type="text"  name="Property_Type" id="Property_Type" class="input" size="50" value="<?php echo $bhxwe['property_type']; ?>"/>
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-3" for="">Occupancy</label>
            <div class="col-sm-9">
              <input type="text"  name="Occupancy" id="Occupancy" class="input" size="50" value="<?php echo $bhxwe['Occupancy']; ?>"/>
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-3" for="">If ARM Loan: Index (%)</label>
            <div class="col-sm-9">
              <input type="text"  name="Loan_Index" id="Loan_Index" class="input poin" size="50" value="<?php echo $bhxwe['loan_index']; ?>"/>
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-3" for="">If ARM Loan: Margin (%)</label>
            <div class="col-sm-9">
              <input type="text"  name="Loan_Margin" id="Loan_Margin" class="input poin" size="50" value="<?php echo $bhxwe['loan_margin']; ?>"/>
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-3" for="">Max. Qualifying Interest Rate (%)*</label>
            <div class="col-sm-9">
              <input type="text"  name="Max_Qual_Interest" id="Max_Qual_Interest" onBlur="fillfield('Max_Qual_Interest');" class="input poin" size="50" value="<?php echo $bhxwe['max_qual_interest_rate']; ?>"/>
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-3" for="">Credit Score*</label>
            <div class="col-sm-9">
              <input type="text"  name="Credit_Score" id="Credit_Score" class="input poin" onBlur="fillfield('Credit_Score');" size="50" value="<?php echo $bhxwe['credit_score']; ?>"/>
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-3" for="">Mortgage Insurance</label>
            <div class="col-sm-9">
              <input type="radio" name="Mort_Insur" id="Mort_Insur" value="Yes" <?php if($bhxwe['mortgage_insurance']=='Yes'){ ?> checked <?php } ?>/>
              &nbsp;&nbsp;Yes&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              <input type="radio" name="Mort_Insur" id="Mort_Insur" value="No" <?php if($bhxwe['mortgage_insurance']=='No'){ ?> checked <?php } ?>/>
              &nbsp;&nbsp;No</div>
          </div>
          <div class="form-group">
            <label class="col-sm-3" for="">Property Street Address*</label>
            <div class="col-sm-9">
              <input type="text"  name="Prop_Street_Addr" id="Prop_Street_Addr" class="input" onBlur="fillfield('Prop_Street_Addr');" size="50" value="<?php echo $bhxwe['property_street']; ?>"/>
            </div>
          </div>
          <div class="form-group">
          <label class="col-sm-3" for="">Property Suite or Apt</label>
          <div class="col-sm-9">
          <input type="text"  name="Prop_Suite_Apt" id="Prop_Suite_Apt" class="input" size="50"  onBlur="fillfield('Prop_Suite_Apt');" value="<?php echo $bhxwe['property_suite']; ?>"/>
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-3" for="">Property City*</label>
            <div class="col-sm-9">
              <input type="text"  name="Prop_City" id="Prop_City" class="input" size="50" onBlur="fillfield('Prop_City');" value="<?php echo $bhxwe['property_city']; ?>"/>
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-3" for="">Property State*</label>
            <div class="col-sm-9">
              <input type="text"  name="Prop_State" id="Prop_State" class="input" size="50" onBlur="fillfield('Prop_State');" value="<?php echo $bhxwe['property_state']; ?>"/>
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-3" for="">Property ZIP Code*</label>
            <div class="col-sm-9">
              <input type="text"  name="ZIP_Code" id="ZIP_Code" class="input poin" size="50" onBlur="fillfield('ZIP_Code');" value="<?php echo $bhxwe['property_zip']; ?>"/>
            </div>
          </div>
          <div class="form-group submit">
            <label class="col-sm-3" for="">&nbsp;</label>
            <div class="col-sm-9">
              <input type="submit" name="landsubmit" value="Update this Pre-Approval Letter" class="btn btn-primary"/>
            </div>
          </div>
          <div>
            <p></p>
