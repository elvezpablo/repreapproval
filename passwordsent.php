...
<head>
<meta charset="utf-8">
<title>Password Sent - RePreApproval</title>
...
<?php include("includes/header.php");?>
  ...
  <div class="breadcrumb-container">
    <div class="container">  
      <div class="row">  
        <div class="col-md-12">
          <h1>Password successfully sent!</h1>
...
<div class="row">
<div class="col-md-8">
<p>We have sent your password to your email address on file. Please check your inbox and login.</p>
<p>Thank you!</p>
</div>
</div> 
</div>
