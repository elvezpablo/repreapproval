...
<?php include("includes/header.php");?>
  ...
  <div class="breadcrumb-container">
    <div class="container">  
      <div class="row">  
        <div class="col-md-12">
          <h1>Awesome icons presented by BWC</h1>
          </div>
      </div> 
    </div> 
  </div>
  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-md-12 icons">
        ...
        <i class="fa fa-mail-reply (alias)"></i>
        ...
        <i class="fa fa-sort-up (alias)"></i>
        <i class="fa fa-spinner"></i>
        <i class="fa fa-square"></i>
        <i class="fa fa-square-o"></i>
        <i class="fa fa-star"></i>
        <i class="fa fa-star-half"></i>
        <i class="fa fa-star-half-empty (alias)"></i>
        <i class="fa fa-star-half-full (alias)"></i>
        ...
        <i class="fa fa-toggle-down (alias)"></i>
        <i class="fa fa-toggle-left (alias)"></i>
        <i class="fa fa-toggle-right (alias)"></i>
        <i class="fa fa-toggle-up (alias)"></i>
        ...
        <i class="fa fa-unsorted (alias)"></i>
