...
<head>
<meta charset="utf-8">
<title>Quick Pre-Approved Letters</title>
...
<?php $SelectLeftCont=mysql_fetch_assoc(mysql_query("select * from quickletter_left where status='1'")); 
$SelectRighttCont=mysql_fetch_assoc(mysql_query("select * from quickletter_right where status='1'")); 
?>
