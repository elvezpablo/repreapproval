            ...
            <div class="row-fluid">
               <div class="span12">
                  ...
                  <!-- BEGIN PAGE TITLE & BREADCRUMB-->
                   <h3 class="page-title">
                     Manage Top Menus <i>(top level menu bar)</i>
                   </h3>
                   <ul class="breadcrumb">
                       <li>
                        ...
                        <div class="widget-body">
                            <form action="menu.php" class="form-horizontal" method="post">
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" placeholder="Menu Title" class="input-xlarge" name="menu" id="menu" value="" />
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" placeholder="Page URL" name="url" id="url" class="input-xlarge" value="" />
                                    </div>
                                </div>
